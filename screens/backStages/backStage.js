...
function BackStage({ route, navigation }) {
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('BackMini',{ stage: '1' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('BackMini', { stage: '2' });
              }}
            >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('BackMini', { stage: '3' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('BackMini', { stage: '4' });
              }}
            >
