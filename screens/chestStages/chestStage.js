...
function ChestStage({ route, navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <Text style={styles.mainText}>{section} 스테이지chest</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('ChestMini',{ stage: '1' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ChestMini', { stage: '2' });
              }}
            >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ChestMini', { stage: '3' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ChestMini', { stage: '4' });
              }}
            >
