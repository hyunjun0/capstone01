...
function ShoulderStage({ route, navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <Text style={styles.mainText}>{section} 스테이지 어께</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('ShoulderMini',{ stage: '1' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ShoulderMini', { stage: '2' });
              }}
            >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ShoulderMini', { stage: '3' });
              }}
            >
          ...
          <View style={styles.stageContainer}>
            ...
            <TouchableOpacity
              style={styles.touchableOpacityButton}
              onPress={() => {
                navigation.navigate('ShoulderMini', { stage: '4' });
              }}
            >
